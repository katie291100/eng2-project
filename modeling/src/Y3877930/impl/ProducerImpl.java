 ...
 * </p>
 * <ul>
 *   <li>{@link Y3877930.impl.ProducerImpl#getName <em>Name</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ProducerImpl extends MinimalEObjectImpl.Container implements Producer {
	...
	protected EClass eStaticClass() {
		return Y3877930Package.Literals.PRODUCER;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Y3877930Package.PRODUCER__NAME, oldName, name));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case Y3877930Package.PRODUCER__NAME:
				return getName();
		}
