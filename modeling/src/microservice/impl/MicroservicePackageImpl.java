...
import microservice.Attribute;
import microservice.Consumer;
import microservice.Controller;
import microservice.Endpoint;
import microservice.EndpointType;
...
public class MicroservicePackageImpl extends EPackageImpl implements MicroservicePackage {
	 ...
	 * @see microservice.MicroservicePackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	...
	public static MicroservicePackage init() {
		...
		Object registeredMicroservicePackage = EPackage.Registry.INSTANCE.get(eNS_URI);
		MicroservicePackageImpl theMicroservicePackage = registeredMicroservicePackage instanceof MicroservicePackageImpl ? (MicroservicePackageImpl)registeredMicroservicePackage : new MicroservicePackageImpl();
	...
	public void initializePackageContents() {
		...
		initEClass(dtoEClass, microservice.DTO.class, "DTO", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getDTO_Name(), ecorePackage.getEString(), "name", null, 0, 1, microservice.DTO.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getDTO_Attributes(), this.getAttribute(), null, "attributes", null, 0, -1, microservice.DTO.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
