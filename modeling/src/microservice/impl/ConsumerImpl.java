 ...
 * </p>
 * <ul>
 *   <li>{@link microservice.impl.ConsumerImpl#getName <em>Name</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ConsumerImpl extends MinimalEObjectImpl.Container implements Consumer {
	...
	protected EClass eStaticClass() {
		return MicroservicePackage.Literals.CONSUMER;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MicroservicePackage.CONSUMER__NAME, oldName, name));
	}
