 ...
 * </p>
 * <ul>
 *   <li>{@link microservice.impl.ProducerImpl#getName <em>Name</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ProducerImpl extends MinimalEObjectImpl.Container implements Producer {
	...
	protected EClass eStaticClass() {
		return MicroservicePackage.Literals.PRODUCER;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MicroservicePackage.PRODUCER__NAME, oldName, name));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case MicroservicePackage.PRODUCER__NAME:
				return getName();
		}
