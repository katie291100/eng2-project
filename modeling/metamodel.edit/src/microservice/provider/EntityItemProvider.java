...
/**
 * This is the item provider adapter for a {@link microservice.Entity} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class EntityItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 MicroservicePackage.Literals.ENTITY__NAME,
				 true,
				 false,
				 false,
	...
	protected void addDtoPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Entity_dto_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Entity_dto_feature", "_UI_Entity_type"),
				 MicroservicePackage.Literals.ENTITY__DTO,
				 true,
				 false,
				 true,
				 null,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(MicroservicePackage.Literals.ENTITY__ATTRIBUTES);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(MicroservicePackage.Literals.ENTITY__ATTRIBUTES,
				 MicroserviceFactory.eINSTANCE.createAttribute()));
	}
