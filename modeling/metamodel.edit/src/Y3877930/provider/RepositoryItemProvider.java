...
/**
 * This is the item provider adapter for a {@link Y3877930.Repository} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class RepositoryItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 Y3877930Package.Literals.REPOSITORY__NAME,
				 true,
				 false,
				 false,
	...
	protected void addEntityPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Repository_entity_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Repository_entity_feature", "_UI_Repository_type"),
				 Y3877930Package.Literals.REPOSITORY__ENTITY,
				 true,
				 false,
				 true,
				 null,
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Repository.class)) {
			case Y3877930Package.REPOSITORY__NAME:
